...
def post_save_cache_categories(sender, **kwargs):
    if kwargs.get('created'):
        cache.set('category', 'category_cache', time_cache)
...
def post_save_cache_subcategories(sender, **kwargs):
    if kwargs.get('created'):
        cache.set('subcategory', 'subcategory_cache', time_cache)
...
def post_save_cache_products(sender, **kwargs):
    if kwargs.get('created'):
        cache.set('product', 'product_cache', time_cache)
...
def post_save_cache_products_in_shop(sender, **kwargs):
    if kwargs.get('created'):
        cache.set('product_in_shop', 'product_in_shop_cache', time_cache)
