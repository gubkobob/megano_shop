    ...
    def add_to_in_comparison(self, product_id):
        ...
        if product not in self.comparison:
            self.comparison[product_id] = {
                ...
                'product_image': str(product.product.image_main.url) if product.product.image_main else '',
                'specification': list(product.product.specification.get().
                                      subspecification.values('name_subspecification', 'text_subspecification'))
                if product.product.specification else '',
